...
import { Home, Library, Sparkles, User, Settings, Users, LogOut, Key, Package } from "lucide-react";
...
export const Navigation = () => {
  ...
  const links = [
    ...
    { to: "/starter-packs/history", label: "Starter Packs", icon: Package, staffOnly: true },
